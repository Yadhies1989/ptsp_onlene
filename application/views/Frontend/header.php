    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="<?php echo base_url('/welcome') ?>">Daftar</a></li>
          <li><a class="getstarted scrollto" href="<?php echo base_url('v4') ?>/#about">Mulai</a></li>
        </ul>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
          ...
          <h2>Pelayanan prima terhadap para pihak adalah salah satu prioritas utama kami.</h2>
          <div class="d-flex justify-content-center justify-content-lg-start">
            <a href="#about" class="btn-get-started scrollto">Mulai</a>
            <a href="https://youtu.be/hpaTBkY8ljE" class="glightbox btn-watch-video"><i class="bi bi-play-circle"></i><span>Tonton Video</span></a>
          </div>
        </div>
