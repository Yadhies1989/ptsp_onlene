          ...
          <!-- batas atas -->
                <form method="post" action="<?php echo base_url('pendaftaran/proses_input_data_diska') ?>" enctype="multipart/form-data">
                  ...
                  <div class="card card-secondary">
                    ...
                    <div class="form-group row">
                      <div class="row col-12">
                        <label for="nama_p1" class="col-sm-4 col-form-label col-form-label-sm">Nama</label>
                        <div class="col-sm-4">
                  ...
                  <div class="card card-secondary">
                    ...
                    <div class="card-body">
                      <div class="form-group row">
                        <div class="row col-12">
                          <label for="nama_p2" class="col-sm-4 col-form-label col-form-label-sm">Nama</label>
                          <div class="col-sm-4">
