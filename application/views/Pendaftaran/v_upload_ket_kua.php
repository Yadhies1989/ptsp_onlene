    ...
    <section class="content">
      ...
      <div class="card card-info">
        <div class="card-header">
          <h3 class="card-title">Keterangan KUA</h3>
        </div>
        <div class="card-body">
          <!-- batas atas -->
          <form id="form-file" method="POST" action="<?php echo base_url('pendaftaran/proses_upload_ket_kua/') ?>" enctype="multipart/form-data">
            <div class="card-header">
                            ...
                            <div class="card-body">
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <?php if ($isbat['file_ket_kua'] == NULL) : ?>
                                          <label for="image"><span style="color:red;">Keterangan KUA Masih Kosong, Silahkan Upload Dengan Klik Tombol Di Bawah!</span></label>
                                        <?php else : ?>
                                            <strong> File : </strong>
                                            <a href="<?php echo base_url() . 'uploads/' . $isbat['file_ket_kua']; ?>" target="_blank">
                                                Lihat File
                                            </a>
                                        <?php endif; ?>
                                        <br>
