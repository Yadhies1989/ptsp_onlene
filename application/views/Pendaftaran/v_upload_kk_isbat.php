  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="card card-info">
        ...
        <div class="card-body">
          <!-- batas atas -->
          <form id="form-file" method="POST" action="<?php echo base_url('pendaftaran/proses_upload_kk_isbat/') ?>" enctype="multipart/form-data">
            <div class="card-header">
                            ...
                            <div class="card-body">
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <?php else : ?>
                                            <strong> File : </strong>
                                            <a href="<?php echo base_url() . 'uploads/' . $isbat['file_kk']; ?>" target="_blank">
                                                Lihat File
                                            </a>
                                        <?php endif; ?>
                                        <br>
