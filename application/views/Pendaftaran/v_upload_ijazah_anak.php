    ...
    <section class="content">
      ...
      <div class="card card-info">
        <div class="card-header">
          <h3 class="card-title">Ijazah Anak</h3>
        ...
        <div class="card-body">
          <!-- batas atas -->
          <form id="form-file" method="POST" action="<?php echo base_url('pendaftaran/proses_upload_ijazah_anak/') ?>" enctype="multipart/form-data">
            <div class="card-header">
                            ...
                            <div class="card-body">
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <?php if ($diska['file_ijazah_anak'] === NULL) : ?>
                                          <label for="image"><span style="color:red;">Ijazah Anak Masih Kosong, Silahkan Upload Dengan Klik Tombol Di Bawah!</span></label>
                                        <?php else : ?>
                                            <strong> File : </strong>
                                            <a href="<?php echo base_url() . 'uploads/' . $diska['file_ijazah_anak']; ?>" target="_blank">
                                                Lihat File
                                            </a>
                                        <?php endif; ?>
                                        <br>
