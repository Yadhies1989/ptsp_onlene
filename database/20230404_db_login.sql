...
insert  into `tbl_daftar_diska`(`id_diska`,`kode`,`nomor_perkara`,`tgl_daftar`,`kode_kua`,`jenis_permohonan`,`nama_p1`,`ayah_p1`,`tempat_lahir_p1`,`tgl_lahir_p1`,`umur_p1`,`nik_p1`,`tgl_nik_p1`,`agama_p1`,`pendidikan_p1`,`pekerjaan_p1`,`alamat_p1`,`nama_p2`,`ayah_p2`,`tempat_lahir_p2`,`tgl_lahir_p2`,`umur_p2`,`nik_p2`,`agama_p2`,`pendidikan_p2`,`pekerjaan_p2`,`alamat_p2`,`nama_anak`,`nik_anak`,`jk_anak`,`agama_anak`,`tempat_lahir_anak`,`tgl_lahir_anak`,`umur_anak`,`pekerjaan_anak`,`pendidikan_anak`,`penghasilan_anak`,`alamat_anak`,`nama_calon`,`nik_calon`,`jk_calon`,`agama_calon`,`ayah_calon`,`tempat_lahir_calon`,`tgl_lahir_calon`,`umur_calon`,`pekerjaan_calon`,`pendidikan_calon`,`alamat_calon`,`lama_mengenal_calon`,`penghasilan_calon`,`tgl_lamaran`,`created_at`,`updated_at`,`file_ktp_p1`,`file_ktp_p2`,`file_kk`,`file_akta_anak`,`file_akta_calon`,`file_ijazah_anak`,`progress`) values (2,'wiztfzwfaa',NULL,'2023-03-28','Yadi Sepriadi','Anak perempuan','Pemohon 1 Lagi bin Ayahnya',NULL,'Bjn','2023-03-01','0 tahun 0 bulan 27 hari','1232365454565','2023-03-03','Islam','Tamat SD/Sederajat','Pekerjaan Pemohon 1','Dusun nama, RT/RW 001/002, Desa/Kel Desa nama, Kec. Kecamatan Nama, Kota/Kab. Kota nama, Prov nama','Pemohon 2 Lagi bin Nama ayah pemohon 2',NULL,'Tempat lahir pemohon 2','2023-03-08','0 tahun 0 bulan 20 hari','12132456587878','Islam','SLTA/Sederajat','Pekerjaan Pemohon 2','Alamat Pemohon 2, RT/RW 001/002, Desa/Kel Desa Pemohon 2, Kec. Kecamatan Pemohon 2, Kota/Kab. Kota Pemohon 2, Prov Pemohon 2','Nama anak binti nama ayah anak','1121356564556','Perempuan','Islam','Tempat lahir anak','2023-03-28','0 tahun 0 bulan 0 hari','Pekerjaan anak','Tidak/Belum Sekolah','1000000','Alamat anak, RT/RW 001/002, Desa/Kel Desa anak, Kec. Kecamatan anak, Kota/Kab. Kota anak, Prov anak','Nama calon bin Nama ayah calon','2322644545','Laki-Laki','Islam',NULL,'Bojonegoro','2023-03-28','0 tahun 0 bulan 0 hari','Pekerjaan calon','Tidak/Belum Sekolah','Alamat calon, RT/RW 001/002, Desa/Kel Desa calon, Kec. Kecamatan calon, Kota/Kab. Kota calon, Prov calon','2','2000000','2023-03-22','2023-03-28 00:00:00','2023-03-28 00:00:00','2_ktp_p1.png','2_ktp_p2.jpeg','2_kk.PNG','2_al_anak.jpeg','2_al_calon.jpeg','2_ijazah_anak.jpeg',NULL);
...
insert  into `user_access_menu`(`id`,`role_id`,`menu_id`) values (1,1,1),(2,1,2),(3,2,2),(4,1,3),(6,2,4),(7,1,4),(8,1,6),(9,1,7),(10,1,8),(11,1,9),(12,1,10),(13,1,11),(14,1,12);
...
insert  into `user_menu`(`id`,`menu`,`icon`) values (1,'Admin','nav-icon fas fa-tachometer-alt'),(2,'User','nav-icon fas fa-users'),(3,'Menu','nav-icon fas fa-folder'),(7,'Petugas',' nav-icon fas fa-users'),(9,'Dashboard','nav-icon fas fa-folder'),(10,'Informasi','nav-icon fas fa-table'),(11,'Pendaftaran','nav-icon fas fa-table');
